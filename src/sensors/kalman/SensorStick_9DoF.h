...
const float accSensityivity[3] = {32.99, 33.14, 32.27};
const float gyroSensityivity[3] = {14.375, 14.375, 14.375};
const float magSensityivity[3] = {1, 1, 1};
...
class SensorStick_9DoF{
  public:
    ...
    float getZero(char sensor,char axis);
    int setZero(char sensor,char axis,float zero[]);
    int setZero(float acc[],float gyro[],float mag[]);
